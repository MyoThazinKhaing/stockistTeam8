...
<form:form method="POST" modelAttribute="transaction"
	...
	<table>
		<tbody>
			<tr>
				...
				<td><form:select path="customerId">
					...
					</form:select></td><td></td><td></td><td></td>
      ...
      <tr>
		<td>Date</td>	
       <td><form:input size="16" path="consumeDate" id="datepicker1" type="date" /></td>
				<td><form:errors path="consumeDate"
       ...
       <%-- <form:errors path="consumeDate" cssStyle="color: red;" /> --%><td></td><td></td><td></td>
			...
			<td>Quantity</td>
			<td><input name="quantity" type="number" min="1" required="required"/></td>
			</tr>
			
			<tr>
				<td></td><td></td><td></td><td></td><td><input type="submit" value="Create" /></td>
				<td></td>
				<td></td>
			</tr>
		</tbody>
