...
public class AdminDamageController {
	...
	@InitBinder("damage")
	private void initDamageBinder(WebDataBinder binder) {
	...
	public ModelAndView damageListByPnumPage(@RequestParam int pnum) {
		
		ModelAndView mav = new ModelAndView("damage-listbypnum");
		ArrayList<Damage> damageList =(ArrayList<Damage>)dService.findCoursesByPNUM(pnum);
		mav.addObject("damageList",damageList);
		return mav;
	}*/
